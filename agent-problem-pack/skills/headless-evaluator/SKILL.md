...
- Read `DESIGN.md` for methodology before large automated runs.
- Do not edit the original problem folders.
- Run `uv run python scripts/pack_tools.py validate` before and after harness changes.
...
1. Validate the pack, then list problems:
